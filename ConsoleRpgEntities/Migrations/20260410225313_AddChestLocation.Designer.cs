...
namespace ConsoleRpgEntities.Migrations
{
    ...
    [Migration("20260410225313_AddChestLocation")]
    partial class AddChestLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.World.Door", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Skeleton", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Characters.Monsters.Monster");

                    b.Property<bool>("HasArmor")
                        .HasColumnType("bit");

                    b.HasDiscriminator().HasValue("Skeleton");
                });

            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Wolf", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Characters.Monsters.Monster");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Monster", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Containers.Room", "CurrentRoom")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Containers.Room", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Containers.Room", "EastRoom")
                        .WithMany()
                        .HasForeignKey("EastRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ConsoleRpgEntities.Models.Containers.Room", "NorthRoom")
                        .WithMany()
                        .HasForeignKey("NorthRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ConsoleRpgEntities.Models.Containers.Room", "SouthRoom")
                        .WithMany()
                        .HasForeignKey("SouthRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ConsoleRpgEntities.Models.Containers.Room", "WestRoom")
                        .WithMany()
